...
console.log("User1 stringify:", JSON.stringify(user1));

const User2 = '{"name":"John", "age":30, "city":"New York"}';
console.log("User2 parsed :", JSON.parse(User2));
